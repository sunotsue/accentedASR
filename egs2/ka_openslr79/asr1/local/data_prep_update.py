...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", help="downloads directory", type=str, default="data/en")
    args = parser.parse_args()

    tsv_path = "%s/line_index.tsv" % args.d #"data/en/line_index.tsv" #"%s/line_index.tsv" % args.d
    print(tsv_path)
